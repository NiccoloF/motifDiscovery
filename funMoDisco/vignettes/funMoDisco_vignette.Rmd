...
kable(params, format = "latex", booktabs = TRUE, longtable = TRUE) %>%
  kable_styling(latex_options = c("hold_position")) %>%
  column_spec(2, width = "20em") %>% # Adjust width of the description column
...
kable(small_params, format = "latex", booktabs = TRUE, longtable = TRUE) %>%
  kable_styling(latex_options = c("hold_position")) %>%
  column_spec(2, width = "18em") %>%  # Adjust the width of the Description column
  column_spec(3, width = "8em")  
```
...
kable(params, format = "latex", booktabs = TRUE, longtable = TRUE) %>%
  kable_styling(latex_options = c("hold_position")) %>%
  column_spec(2, width = "20em") %>%  # Set width of the Description column
  column_spec(3, width = "8em")
```
